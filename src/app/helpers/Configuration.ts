export class Configuration {
    public static baseServerAPIEndpoint ="http://localhost:56986";//"http://172.16.6.139:9090/"; // "http://172.16.6.139:9090/";//""http://139.144.10.218:9090/";    //"http://139.144.10.218:8080/";
