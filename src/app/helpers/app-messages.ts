export class AppMessages {
    public static PurchaseInqAddedSuccessMsg:string="Purchase inquery added successfully.";
    public static PurchaseInqItemAddedSuccessMsg:string="Purchase inquery item added successfully.";
    public static PurchaseInqItemUpdateSuccessMsg:string="Purchase inquery item updated successfully.";
