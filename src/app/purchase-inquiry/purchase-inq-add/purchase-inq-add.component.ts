...
export class PurchaseInqAddComponent implements OnInit {
  ...
  constructor(private purchaseInquiryService: PurchaseInquiryService, private commonService: Commonservice,private toast:ToastService,private translate: TranslateService) { 
